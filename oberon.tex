...
{\tt X\/}, {\tt Y\/}, {\tt W\/}, {\tt H\/} define the viewer's rectangle on the screen, i.e. location
...
terminology. It is justified because handle is a procedure variable (a
handler) whose identity depends on the specific viewer. A call
