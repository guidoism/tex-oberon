...
\noindent {\tt buf\/} is an internal buffer containing the consumed data. {\tt fnt\/}, {\tt col\/}, and {\tt voff\/} specify the current looks for the next character consumed by this writer.
...
2.) Every piece is represented by a descriptor {\tt (f, pos, len)\/}, where
