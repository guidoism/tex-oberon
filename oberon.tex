...
[Goldberg]. Perhaps the most conspicuous among several significant
...
management [Binding, Wille] is hard to justify. Therefore, alternate
strategies to structure a display screen have been looked for. An
interesting class of established solutions can be titled as {\it
  tiling\/}. There are several variants of tiling [Cohen]. Perhaps the
...
[Teitelman]. However, the Oberon variant differs from the Cedar
...
[Goldberg]. In Oberon, {\tt CopyBlock\/} is used primarily for scrolling
...
in the System toolbox provides a user interface:
